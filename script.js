...
function openApp(appNumber) {
    ...
    if (appNumber === 1) {
        ...
        modalBody.innerHTML = '<h2>Lenguajes de Programación</h2><ul><li>HTML: Muy bien</li><li>CSS: Muy bien</li><li>JavaScript: Muy bien</li><li>C#: en proceso</li><li>Java: en proceso</li><li>SQL: Muy Bien</li></ul>';
